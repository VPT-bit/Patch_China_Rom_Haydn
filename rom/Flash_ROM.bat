...
echo.¢ÙThe data needs to be cleared when flashing HyperOS for the first time.
echo.¢Ú If packets of decrypted data and non-decrypted data are flushed each other, the data needs to be cleared.
echo.
...
if "!QQGROUP!" neq "" (
	echo.If stuck ^<waiting for any device^>Please go to the group (!QQGROUP!) file to search for "Android driver"
	echo.If stuck ^<waiting for any device^>Please go to the group (!QQGROUP!) file to search for "Android driver"
	echo.If stuck ^<waiting for any device^>Please go to the group (!QQGROUP!) file to search for "Android driver"
) else (
    echo. If stuck at ^<waiting for any device^>, please go to the group (607192055) file to search for "Android driver"
	echo. If stuck at ^<waiting for any device^>, please go to the group (607192055) file to search for "Android driver"
	echo. If stuck at ^<waiting for any device^>, please go to the group (607192055) file to search for "Android driver"
